<%@ Page Language="C#" MasterPageFile="~/Home.master" AutoEventWireup="true" CodeFile="seeker_login.aspx.cs" Inherits="_Default" Title="Login Page" %>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:HyperLink ID="HyperLink2" runat="server" Font-Size="Small" 
                        ForeColor="#E46115" NavigateUrl="~/seeker_fp.aspx">Forgot password ?</asp:HyperLink>
                </td>
            </tr>
            <tr>
                <td align="right" style="width: 386px">
