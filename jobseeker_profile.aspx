<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="jobseeker_profile.aspx.cs" Inherits="jobseeker_profile" Title="Profile Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <p>
        ...
        <asp:Label ID="Label4" runat="server" Font-Bold="True" Font-Size="Large" 
            ForeColor="#E46115" Text="Professional Details" Font-Underline="True" Visible="false"></asp:Label>
        &nbsp;
